...
% This file will hold only the vertices of the STL file for fast
% visualisation in the graphical user interface:
VERTICESfilename = 'renal_tree_vertices.mat';
...
VERfilepath = [geometryFolder filesep VERTICESfilename];
...
save(VTUsavepath,'vtuStruct','vtuProperties','-v7.3')
...
save(VERfilepath,'X','Y','Z');

STLfile = STLfilename;

if createSTL == true
    STLunit = vtuProperties.lengthUnits;
end
...
Visualization.VesselVerticesFile = VERTICESfilename;
Visualization.Fraction = fraction;

save(GEOMETRYfilepath,'STLfile','STLunit','EmbedVessel',...
    'BoundingBox','Rotation','Visualization');
