function main_RF(filename, folder, savename, varargin)
% =========================================================================
% SIMULATE RF DATA
% input:    filename:    the file containing the simulation settings
%           folder:      the folder containing the ground truth data
...
load(filename,'Acquisition','Geometry','Medium',...
...
% Location of the ground truth frames data:
folder = [run_param.GroundTruthPath filesep folder];
...
check_ground_truth_data(folder, Acquisition, Microbubble, savedir)
